...
generated by `harbor_serve()`. That's Mode 2 — fine for development
and single-operator deployments. But multi-tenant production almost
always needs something stricter: multi-tenant token tables, RBAC,
time-limited tokens, etc. — that's what these recipes give you.
