...
// __HARBOR_ADMIN__:resource:action authz integration.
//
// PR-2 just exposes:
...
//
// Both routes are wrapped in HarborHttpServer::ActiveRequestGuard so
...
class AdminHandlers {
public:
	explicit AdminHandlers(HarborHttpServer &server);
